...
public final class SharedSaltKey extends MacKey {
     ...
     *
     * @param key Symmetric Key consisting of 64 bytes concatenated from shared public keys
     */
    public SharedSaltKey(final byte[] key) {
        super(key, CryptographicKeyType.SHARED_SALT);
    }
}
